...
- (void)configRecordingHUDImageWithPeakPower:(CGFloat)peakPower {
    NSString *imageName = @"m_RecordingSignal00";
...
- (void)setup {
    ...
    if (!_microPhoneImageView) {
        ...
        microPhoneImageView.image = [UIImage imageNamed:@"m_RecordingBkg"];
    ...
    if (!_recordingHUDImageView) {
        ...
        recordHUDImageView.image = [UIImage imageNamed:@"m_RecordingSignal001"];
    ...
    if (!_cancelRecordImageView) {
        ...
        cancelRecordImageView.image = [UIImage imageNamed:@"m_RecordCancel"];
