...
NSString * const ZERO_WIDTH_SPACE = @"\u200B";
NSString * const LINE_SEPARATOR = @"\u2028";
NSString * const PARAGRAPH_SEPARATOR = @"\u2029";
...
- (void)clicked
{
    if ([self.delegate respondsToSelector:@selector(textView:atIndex:)]) {
        [self.delegate textView:self atIndex:[self stringIndexAtPoint:self.mouseLocation]];
    }
}
