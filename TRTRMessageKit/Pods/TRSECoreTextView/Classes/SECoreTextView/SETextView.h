...
extern NSString * const ZERO_WIDTH_SPACE;
extern NSString * const LINE_SEPARATOR;
extern NSString * const PARAGRAPH_SEPARATOR;
...
- (BOOL)textView:(SETextView *)textView atIndex:(NSUInteger)charIndex;
